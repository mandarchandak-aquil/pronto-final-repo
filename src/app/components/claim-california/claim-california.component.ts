...
@Component({
  selector: 'app-claim-california',
  templateUrl: './claim-california.component.html',
  styleUrls: ['./claim-california.component.css']
})
export class ClaimCaliforniaComponent implements OnInit {
  @ViewChild('search') searchElementRef: ElementRef;
dataReq;
loading : boolean = true;
  california: FormGroup;
  ...
  ngOnInit(): void {
   ...
   this.california = this.formBuilder.group({
                        "state" : "California",
   ...
   loadmap(e)
   {
    ...
    initService() {
     ...
     var request = {
      input: this.california.get('insured_information.home_address').value,
