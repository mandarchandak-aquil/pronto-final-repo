...
@Component({
  selector: 'app-product-mexico-california-insurance',
  templateUrl: './product-mexico-california-insurance.component.html',
  styleUrls: ['./product-mexico-california-insurance.component.css']
})
export class ProductMexicoCaliforniaInsuranceComponent implements OnInit {
 ...
 loading :boolean = true;  
    ...
    basic_coverage_subtitle1;
    basic_coverage_includes;
    basic_addtional_cov;
    full_coverage_subtitle1;
  ...
  this.CaliforniaMexicoAutoInsurance();
  }
  ...
  CaliforniaMexicoAutoInsurance(){
    ...
    this.api_product.CaliforniaMexicoAutoInsurance(this.dataReq).subscribe((data: {}) => {
    ...
    sessionStorage.setItem('meta_robots',data['products'].meta_robots);  
       ...
       this.ads = data['banners'];
        ...
        this.policy_titles = JSON.parse(data['products'].policy_titles);
      	...
      	this.basic_coverage_subtitle1 =  this.sanitizer.bypassSecurityTrustHtml(this.productArr.basic_coverage_subtitle1);
      	...
      	this.full_coverage_subtitle1  = this.sanitizer.bypassSecurityTrustHtml(this.productArr.full_coverage_subtitle1);
      	...
      	console.log('full_coverage_elite_includes',this.full_coverage_elite_includes);
