...
@Component({
  selector: 'app-quick-pay-login',
  templateUrl: './quick-pay-login.component.html',
  styleUrls: ['./quick-pay-login.component.css']
})
export class QuickPayLoginComponent implements OnInit {
  socialdata;
   ...
   console.log('source',data);
        ...
        this.dashservice.userdata = data;
         ...
         console.log('oooooooooooooosdoadooooooooooo');
                ...
                this.duplicate = true;
                     this.router.navigate(['/quick-pay-login']);
                }else{
                this.router.navigate(['/quick-pay-login']);
                }
