...
@Component({
  selector: 'app-product-mexico-texas-insurance',
  templateUrl: './product-mexico-texas-insurance.component.html',
  styleUrls: ['./product-mexico-texas-insurance.component.css']
})
export class ProductMexicoTexasInsuranceComponent implements OnInit {
...
TexasMexicoAutoInsurance(){
    ...
    this.api_product.TexasMexicoAutoInsurance(this.dataReq).subscribe((data: {}) => {
